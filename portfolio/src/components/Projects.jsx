...
import { projects as importedProjects } from "../data/content";
...
const Projects = () => {
  ...
  // ✅ Added Sales Savvy project here
  const projects = useMemo(() => {
    const salesSavvy = {
      ...
      icon: "🛍️",
      description:
        "A full-stack e-commerce platform with JWT authentication, product management, cart, checkout, and order processing.",
      tech: [
        "Java 17",
        "Spring Boot 3",
        "Spring Security",
    ...
    return [salesSavvy, ...importedProjects];
  }, []);
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-white/70">
              Modern experiences with crisp visuals, instant feedback, and
